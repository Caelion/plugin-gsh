...
class gsh extends eqLogic {
	...
	public static function getSupportedType() {
		return array(
			...
			'action.devices.types.BLINDS' => array('name' => __('Store', __FILE__), 'traits' => array('Modes', 'OpenClose', 'StartStop')),
			'action.devices.types.SHUTTER' => array('name' => __('Volet', __FILE__), 'traits' => array('Modes', 'OpenClose', 'Rotation', 'StartStop')),
			'action.devices.types.CURTAIN' => array('name' => __('Rideaux', __FILE__), 'traits' => array('OpenClose', 'StartStop')),
			...
			'action.devices.types.GARAGE' => array('name' => __('Porte Garage', __FILE__), 'traits' => array('OpenClose', 'StartStop')),
			'action.devices.types.GATE' => array('name' => __('Portail', __FILE__), 'traits' => array('OpenClose', 'StartStop')),
